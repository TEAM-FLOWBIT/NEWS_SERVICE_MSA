pipeline {
    ...
    environment {
        ...
        REPOSITORY_URL= 'https://github.com/TEAM-FLOWBIT/BOARD_SERVICE_MSA.git'

        //docker-hub
        registryCredential = 'docker-hub'

        CONTAINER_NAME = 'flowbit-boardservice'
        IMAGE_NAME = 'kimminwoo1234/flowbit-boardservice'
    }
    ...
    stages {
        ...
        stage('Prepare') {
            steps {
                ...
                git branch: 'develop',
                    url: 'https://github.com/TEAM-FLOWBIT/BOARD_SERVICE_MSA.git'
            }
            post {
                success {
        ...
        stage('Build Maven') {
            steps {
                ...
                dir('.'){
                    sh '''
                        pwd
                        cd /var/jenkins_home/workspace/flowbit-boardservice
