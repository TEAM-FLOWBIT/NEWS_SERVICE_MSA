...
public class BoardCommentServiceImpl implements BoardCommentService {
    ...
    public CreatedBoardCommentResponseDto createBoardComment(CreateBoardCommentRequestDto createBoardCommentRequestDto) {
        ...
        BoardComment boardComment = createBoardCommentRequestDto.toEntity(Translator.getMemberId(memberId), board, createBoardCommentRequestDto.getContent());
    ...
    public void deleteBoardComment(Long commentId) {
        ...
        if(boardComment.getMemberId().getId().equals(memberInfo.getData().getId())) {
